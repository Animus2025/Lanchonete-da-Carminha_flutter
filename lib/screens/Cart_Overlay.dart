    ...
    return GestureDetector(
      ...
      child: DraggableScrollableSheet(
        ...
        builder: (context, scrollController) {
          return GestureDetector(
            onTap: () {}, // Impede que o tap dentro feche o overlay
            child: Container(
                            ...
                            showDialog(
                              ...
                              builder: (context) => Dialog(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isDark ? AppColors.pretoClaro : AppColors.branco, // Ajuste aqui
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(
                                          color: isDark ? AppColors.laranja : AppColors.preto, // Texto claro no dark
                                          fontSize: 20,
                                          letterSpacing: 1,
                                        ),
